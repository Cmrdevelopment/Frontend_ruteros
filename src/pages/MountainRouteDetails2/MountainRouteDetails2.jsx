    ...
    return (
        <div className="mountainRouteDetails2-container">
            ...
            <div className="mountainRouteDetails2-image-and-info-container">
                ...
                <div className="mountainRouteDetails2-info-container">
                    <div className="mountainRouteDetails2-title-and-state">
                        ...
                        <div className="mountainRouteDetails2-mountainRouteState">{mountainRoute?.routeState}</div>
                    </div>
                    <div className="mountainRouteDetails2-read-ratings">
                        {mountainRoute && <ReadOnlyMountainRouteRating mountainRoute={mountainRoute} />} ({mountainRoute?.ratings.length})
                    </div>
                    <div className="mountainRouteDetails2-info-localization-distance-difficulty-durartion">
                        <div className="mountainRouteDetails2-info-routeLocation">
                            ...
                            <div className="mountainRouteDetails2-info-mountainRoute-detail">
                                <FaMapMarker style={{ fontSize: '1.6em' }} /> {mountainRoute?.routeLocation}
                            </div>
                        </div>
                        <div className="mountainRouteDetails2-info-routeLoDistance">
                            <p>Distancia</p>
                            <div className="mountainRouteDetails2-info-mountainRoute-detail">
                                <GiPathDistance style={{ fontSize: '1.6em' }} /> {mountainRoute?.routeDistance} Kms
                            </div>
                        </div>
                        <div className="mountainRouteDetails2-info-routeDifficulty">
                            <p>Dificultad</p>
                            <div className="mountainRouteDetails2-info-mountainRoute-detail">
                                <MdReportProblem style={{ fontSize: '1.6em' }} /> {mountainRoute?.difficulty}
                            </div>
                        </div>
                        <div className="mountainRouteDetails2-info-routeDuration">
                            <p>Duración</p>
                            <div className="mountainRouteDetails2-info-mountainRoute-detail">
                                <BiTime style={{ fontSize: '1.6em' }} /> {mountainRoute?.routeDuration} hora/s
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="mountainRouteDetails2-mountainRoute-rating-writeRating-container">
                ...
                {mountainRoute && <WriteRatingForMountainRoute mountainRouteToRate={mountainRoute} />}{' '}
            </div>
                ...
                <div className="mountainRouteDetails2-info-itemsToCArry">
                    ...
                    <div className="mountainRouteDetails2-info-itemToCarry">
                        ...
                        <div className="mountainRouteDetails2-icons-itemsToCarry-container">
                            {itemsToCarryArr
                                .filter((itemToCarry) => mountainRoute?.itemsToCarry.includes(itemToCarry.name))
