...
//   const [mountainRouteRatingsFromDBFirstTime, setMountainRouteRatingsFromDBFirstTime] = useState({});
...
//     console.log('WriteRatingForMountainRoute -> mountainRouteToRate: ', mountainRouteToRate);
//     return null;
//   }
...
//           await createRating({ score: ratingValue, referenceMountainRoute: mountainRouteToRate._id }),
//         );
