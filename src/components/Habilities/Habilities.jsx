    ...
    return (
        <>
            <section className="choose_technologies-container-choose-padre">
                <p className="choose_technologies-container-choose">Selecciona tus habilidades ruteras</p>
                <div className="father-container-technologies">
                    {habilitiesArr.map((hability, index) => (
                        <figure key={`${hability.name}-${index}`} className="tecnologia-item" id={hability.name}>
                            <div className="image-container">
                                <img className="tech-image" src={hability.image} alt={hability.name} />
                            </div>
                            <p className="tech-image-text">{hability.name}</p>
                            <ToggleHabilities setArrayHabilities={setArrayHabilities} arrayHabilities={arrayHabilities} />
                        </figure>
                    ))}
                </div>
                <button
